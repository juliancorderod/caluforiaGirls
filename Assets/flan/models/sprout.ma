...
//Name: sprout.ma
//Last modified: Sun, Oct 01, 2017 12:09:21 PM
//Codeset: UTF-8
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.2592070208093356 9.524303809580557 7.98386834942636 ;
	setAttr ".r" -type "double3" -48.938352729326624 344.1999999999183 -3.3054408697959972e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "53698DE8-2C4C-B54D-5E24-35BE30388CB1";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 12.631648080951111;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "7CC945C5-C549-4EF5-ED94-7C969DF5509A";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "0C3E7D4B-3044-728A-39E8-A3973ACCD922";
createNode displayLayer -n "defaultLayer";
	rename -uid "3DBEE2EB-4A48-A0EE-B2E7-D6A604CD3232";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "36C5BC56-F24B-9DE9-A3B0-CEBD923BE549";
